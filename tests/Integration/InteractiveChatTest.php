...
class InteractiveChatTest extends IntegrationTestCase
{
    ...
    public function test_chat(): void
    {
        ...
        // Welcome banner
        echo "\n\033[1;36m==================================================\033[0m\n";
        echo "\033[1;32m      Welcome to Sisly AI Emotional Coaching      \033[0m\n";
        echo "\033[1;36m==================================================\033[0m\n";
        echo "Active LLM Driver: \033[1;33m" . config('sisly.llm.driver') . "\033[0m\n";
        echo "Active Model:      \033[1;33m" . config('sisly.llm.' . config('sisly.llm.driver') . '.model') . "\033[0m\n";
        echo "--------------------------------------------------\n\n";

        // Let user choose a coach
        echo "Select an emotional support coach:\n";
        echo "  \033[1;32m1\033[0m) Meetly  - Anxiety, panic, and presentation fear\n";
        echo "  \033[1;32m2\033[0m) Vento   - Anger, frustration, and quick venting\n";
        echo "  \033[1;32m3\033[0m) Loopy   - Overthinking, replaying conversations\n";
        echo "  \033[1;32m4\033[0m) Presso  - Overwhelm, acute stress, and deadlines\n";
        echo "  \033[1;32m5\033[0m) Boostly - Self-doubt, confidence booster\n";
        echo "  \033[1;32m6\033[0m) Safeo   - General anxiety, grounding, and sleep\n";
        ...
        // Select language
        echo "Select language (en / ar) [default: en]: ";
        ...
        while (true) {
            ...
            echo "\033[0;90m[Thinking...]\033[0m\r";
        ...
        echo "\033[1;32mSession ended. Thank you for using Sisly!\033[0m\n\n";
    ...
    private function printCoachReply($response): void
    {
        ...
        if ($response->arabicMirror) {
            echo "\033[0;32mArabic Mirror > \033[0m" . $response->arabicMirror . "\n";
        }
        ...
        if ($response->prescription) {
            ...
            echo "\n\033[1;35m┌────────────────────────────────────────────────────────┐\033[0m\n";
            echo "\033[1;35m│ ★ RECOMMENDATION PRESCRIBED: " . str_pad(strtoupper($p->mediaCategory), 25) . " │\033[0m\n";
            echo "\033[1;35m├────────────────────────────────────────────────────────┤\033[0m\n";
            echo "\033[1;35m│ Title:       \033[0m" . str_pad($p->title, 42) . " \033[1;35m│\033[0m\n";
            echo "\033[1;35m│ Description: \033[0m" . str_pad(substr($p->description, 0, 42), 42) . " \033[1;35m│\033[0m\n";
            echo "\033[1;35m│ Duration:    \033[0m" . str_pad($p->duration . " mins", 42) . " \033[1;35m│\033[0m\n";
            echo "\033[1;35m│ Audio:       \033[0m" . str_pad(substr($p->audioPath, 0, 42), 42) . " \033[1;35m│\033[0m\n";
            echo "\033[1;35m│ Reason:      \033[0m" . str_pad(substr($p->reason, 0, 42), 42) . " \033[1;35m│\033[0m\n";
            echo "\033[1;35m└────────────────────────────────────────────────────────┘\033[0m\n";
        }
    }
}
